    ...
    return (
      <AuctionDetailsCard mb={['24px', null, null, '0']}>
        ...
        <CardBody>
          ...
          <img src="/images/loader.svg" alt="loader"/>          </Flex>
        </CardBody>
      </AuctionDetailsCard>
    )
  }
      ...
      return (
        <>
          ...
          <Flex justifyContent="space-between" width="100%" pt="24px">
            ...
            <Text small>{getBalanceNumber(amount).toLocaleString()} PLAY</Text>
          </Flex>
          ...
          <Text color="textSubtle" small>
            {t('If your bid is unsuccessful, you’ll be able to reclaim your PLAY after the auction.')}
          </Text>
        </>
      )
    }
